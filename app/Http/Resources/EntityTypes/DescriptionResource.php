...
use App\Services\DescriptionResourceService;
use App\Services\EntityService;
use App\Services\FieldService;
use App\Services\NpaService;

class DescriptionResource extends EntityResource implements EntityResourceContract
{
    /**
    ...
    public function toArray($request)
    {
        ...
        if (!is_null($payload)) {
            ...
            $resourceService = new DescriptionResourceService();
